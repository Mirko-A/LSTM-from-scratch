...
static std::vector<float> train(LSTM &model, const std::vector<Matrix> &one_hot_inputs,
                                const std::vector<Matrix> &one_hot_labels, uint32_t vocab_size,
                                uint32_t epochs) {
...
static std::tuple<std::string, float> test(LSTM &model, const std::vector<Matrix> &one_hot_inputs,
